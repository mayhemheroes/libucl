...
$CC $SANITIZER_FLAGS $LIB_FUZZING_ENGINE "$HARNESS" $INCS "$LIBUCL" -o /mayhem/ucl_add_string_fuzzer
$CC $SANITIZER_FLAGS "$STANDALONE_FUZZ_MAIN" "$HARNESS" $INCS "$LIBUCL" -o /mayhem/ucl_add_string_fuzzer-standalone
